...
class NA(gr.top_block):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.zeromq_pub_sink_0 = zeromq.pub_sink(gr.sizeof_gr_complex, 1, 'tcp://192.168.2.2:5555', 100, False, -1)
...
def main(top_block_cls=NA, options=None):
    tb = top_block_cls()
